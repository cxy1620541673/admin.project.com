...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<i class="icon-angle-right"></i>
				<a href="/Task/AddTask">任务添加</a> 
			</li>
		</ul>
	</div>
</div>

<form class="form-horizontal" id="addtask-form" action="/Task/AjaxAddTask">
	<div class="form-group">
		<label class="col-sm-1 control-label"><font color="red"> * </font>任务标题</label>
		<div class="col-sm-5 error-tips">
			<input type="text" class="form-control" id="t_title" name="t_title" data-required="必填">
		</div>
	</div>
	<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 error-tips">
					<div class="input-group date from_datetime">
						<input type="text" class="form-control" id="t_start_time" name="t_start_time" size="16" readonly>
			...
			<div class="form-group">
				...
				<div class="col-sm-8 error-tips">
					<div class="input-group date to_datetime">
						<input type="text" class="form-control" id="t_end_time" name="t_end_time" size="16" readonly>
						<span class="input-group-btn">
							<button class="btn default date-reset" type="button"><i class="icon-remove"></i></button>
						</span>
						<span class="input-group-btn">
	...
	<div class="form-group">
		...
		<div class="col-sm-10 error-tips">
			<textarea class="form-control" id="t_desc" name="t_desc" data-required="必填"></textarea>
		</div>
	</div>
	<div class="form-group">
